...
const PROFILE_FORM = document.getElementById('profileForm'),
    NOMBRE_ADMINISTRADOR = document.getElementById('nombre_perfil'),
    APELLIDO_ADMINISTRADOR = document.getElementById('apellido_perfil'),
    CORREO_ADMINISTRADOR = document.getElementById('correo_perfil');
// Constante para establecer la modal de cambiar contraseña.
const PASSWORD_MODAL = new bootstrap.Modal('#modal_contra');
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (DATA.status) {
        ...
        CORREO_ADMINISTRADOR.value = ROW.correo_usuario;
    } else {
